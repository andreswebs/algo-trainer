...
| PMS-007 | Implement `ProblemManager` write API (CRUD) for user/custom problems | 📋 Todo |
...
| PMS-013 | Define workspace layout + path resolution rules                      | 📋 Todo |
| PMS-014 | Implement `WorkspaceManager` init + structure creation               | 📋 Todo |
...
| PMS-018 | Problem parser/database tests                                        | 📋 Todo |
...
### Lane A (Problems core): 6/8 completed
...
### Lane C (Workspace): 0/6 completed
